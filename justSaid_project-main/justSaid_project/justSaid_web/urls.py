...
from .views import AddPostView, HomeView, BlogDetailView, UpdatePostView,DeletePostView,AddCategoryView,CategoryView,CategoryListView,LikeView,AddCommentView
from . import views
